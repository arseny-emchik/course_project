...
print back_propagation.getResult(network.activate, data_set)
...
# print decision_tree.getResult(clf.predict, data_set)
#
# test 3
...
# print resilient_propagation.getResult(network.activate, data_set)
#
# #test 4
...
# control.draw_confusion_matrix(clf.predict, data_set)
# data_set = support_vector.get_data_set(100)
# print support_vector.getResult(clf.predict, data_set)
